...
iphone_xlog_project_with_bitcode = Project(RELATIVE_PATH + "mars-log-iphone.xcodeproj", "iphone", set(["Release-iphoneos", "Release-iphonesimulator"]), "mars", "mars.framework", "-fembed-bitcode")
...
mac_xlog_project_with_bitcode = Project(RELATIVE_PATH + "mars-log-mac.xcodeproj", "macosx", set(["Release"]), "mars", "mars.framework", "-fembed-bitcode")

APPLE_PROJECTS = (iphone_project, iphone_project_with_bitcode, iphone_xlog_project, iphone_xlog_project_with_bitcode, mac_project, mac_xlog_project, mac_xlog_project_with_bitcode)
